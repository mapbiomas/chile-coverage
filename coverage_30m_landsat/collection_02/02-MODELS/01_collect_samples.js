...
var nTrainingPoints = 5000 ;  // Number of points to training
...
years.forEach(
    function (year) {
        ...
        mosaicYear = mosaicYear
                      //.select(featureSpace)
                      .clip(selectedRegionSimplified); //Podemos filtrar las variables a usar
        ...
        var pointsName = 'samples-points-' + ecoregionId + '-' + year.toString() + '-' + versionOutput;
